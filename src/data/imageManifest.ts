...
export const imageManifest: ManifestImage[] = [
  ...
  {
    id: 'hamburg-port',
    file: '/assets/images/hamburg-port.svg',
  ...
  {
    id: 'dubai-operations',
    file: '/assets/images/dubai-operations.svg',
  ...
  },
  {
    ...
    file: '/assets/images/central-asia-corridor.svg',
  ...
  {
    id: 'kabul-corridor',
    file: '/assets/images/kabul-corridor.svg',
  ...
  {
    id: 'karachi-port',
    file: '/assets/images/karachi-port.svg',
